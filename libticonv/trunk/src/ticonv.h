...
typedef enum 
{
	...
	CALC_TI84PC, CALC_TI84PC_USB, CALC_TI83PCE_USB, CALC_TI84PCE_USB, CALC_TI82A_USB, CALC_TI84PT_USB, CALC_TI82AEP_USB, // 22
	CALC_NSPIRE_CRADLE, // 24
	CALC_NSPIRE_CLICKPAD, CALC_NSPIRE_CLICKPAD_CAS, CALC_NSPIRE_TOUCHPAD, CALC_NSPIRE_TOUCHPAD_CAS, // 28
	CALC_NSPIRE_CX, CALC_NSPIRE_CX_CAS, CALC_NSPIRE_CMC, CALC_NSPIRE_CMC_CAS, // 32
	CALC_NSPIRE_CXII, CALC_NSPIRE_CXII_CAS, CALC_NSPIRE_CXIIT, CALC_NSPIRE_CXIIT_CAS, // 36
